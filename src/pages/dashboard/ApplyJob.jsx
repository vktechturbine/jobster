...
const ApplyJob = () => {
  ...
  const data = useSelector((state) => {
    console.log("state :=> ", state.applyJob);
      ...
      {data?.map((job) => (
        <div className="applyjob">
          ...
          <div className="secondHead">
            ...
            <div className="content1">
              <div className="icon1">
                <img src="/src/assets/images/date.png" />
              </div>
              <div className="head1">
                <h3>{job.createdAt.slice(0, 10)}</h3>
              </div>
            </div>
            <div className="content1">
              <div className="icon1">
                <img src="/src/assets/images/jobs.png" />
              </div>
              <div className="head1">
                <h3>{job.jobType}</h3>
              </div>
          ...
          <button className="btn" onClick={() => dispatch(apply_Job(job))}>
            ApplyJob
          </button>
        </div>
  ))}
