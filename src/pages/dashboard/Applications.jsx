...
import {
  applications,
  selection_status,
} from "../../features/allJobs/applications";
  ...
  return (
    <table className="table">
      <thead className="thead-dark">
        <tr>
          <th
            style={{ textAlign: "center", background: "#3d89f8" }}
            scope="col"
          >
            Candidate Name
          </th>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>
                <select
                  ...
                  onChange={(e) =>
                    handleOptionChange(e.target.value, dats.userId, dats.jobId)
                  }
                >
                  <option
                    selected={dats.jobStatus === "Selected"}
                    value={"Selected"}
                  >
                    Selected
                  </option>
                  <option
                    selected={dats.jobStatus === "Pending"}
                    value={"Pending"}
                  >
                    Pending
                  </option>
                  <option
                    selected={dats.jobStatus === "Rejected"}
                    value={"Rejected"}
                  >
                    Rejected
                  </option>
