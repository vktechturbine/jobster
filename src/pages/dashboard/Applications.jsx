...
const Applications = () => {
    ...
    const data = useSelector((state) => {
        ...
        console.log(state.applications.jobapplications);
        return state.applications.jobapplications.jobs;
                ...
                {data?.map(dats => (
                    <tr>
                        ...
                        <td style={{ textAlign: "center" }}>
                            <select class="form-select form-select-sm mb-1" aria-label=".form-select-lg example" onChange={(e) => handleOptionChange(e.target.value, dats.userId, dats.jobId)}>
